function [X_new, U, V, W, F, objsum, score_f, idx, iter] = CDRNMF(X, kk, Ds, Ws, alpha, beta, lambda, NIter, l)
% QDRNMF: Cascaded Dimensionality Reduction Nonnegative Matrix Factorization for Data Representation.
% 
% Input:
...
for iter = 1:NIter
    ...
    W = W.*(alpha*V'*V*F' + U'*X*V*W + V'*X'*U*W)./(alpha*V'*V*W*F*F' + beta*Q*W + U'*U*W*W'*V'*V*W + V'*V*W*W'*U'*U*W);
    F = F.*(W'*V'*V)./(W'*V'*V*W*F);
    % ==============================================================
